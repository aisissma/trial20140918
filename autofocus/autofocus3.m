...
freq12 = histc(data, x);
freq12 = freq12 / (sum(freq12) * binWidth);
edges2 = x(1:end-1) + (binWidth/2);
freq22 = freq12(1:end-1);
...
parasF = lsqcurvefit(func, initPara, edges2, freq22, lb, ub, options)
retF2 = multiFunction(parasF, edges2, funcNum, paraNum);
